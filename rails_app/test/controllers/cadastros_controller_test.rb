...
class CadastrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cadastro" do
    assert_difference('Cadastro.count') do
      post cadastros_url, params: { cadastro: { endereco: @cadastro.endereco, nome: @cadastro.nome } }
    end
  ...
  test "should update cadastro" do
    patch cadastro_url(@cadastro), params: { cadastro: { endereco: @cadastro.endereco, nome: @cadastro.nome } }
